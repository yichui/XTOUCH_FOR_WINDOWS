...
ButtonGroup EC1Bt[16];
//extern EncodersCompact9To16Component * pEncodersCompact9To16Component;
//[/MiscUserDefs]

//==============================================================================
EncodersCompact1To8Component::EncodersCompact1To8Component ()
{
    ...
    ECOT_NO_EN7->setButtonText ("CC11");
...
//==============================================================================
void EncodersCompact1To8Component::paint (Graphics& g)
{
...
void EncodersCompact1To8Component::resized()
{
...
void EncodersCompact1To8Component::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    else if (buttonThatWasClicked == ECO_BEH_EN1)
    {
        ...
        if (!(EC1Bt[8].BT2->getButtonText().compare("MMC") == 0) && !(EC1Bt[8].BT2->getButtonText().compare("Program") == 0) 
			&& !(EC1Bt[8].BT2->getButtonText().compare("CC")==0 && (EC1Bt[8].BT4->getButtonText().compare("Inc/+1")==0 || EC1Bt[8].BT4->getButtonText().compare("Dec/-1")==0))){
    ...
    else if (buttonThatWasClicked == ECO_BEH_EN2)
    {
		...
		if (!(EC1Bt[9].BT2->getButtonText().compare("MMC") == 0) && !(EC1Bt[9].BT2->getButtonText().compare("Program") == 0) 
			&& !(EC1Bt[9].BT2->getButtonText().compare("CC")==0 && (EC1Bt[9].BT4->getButtonText().compare("Inc/+1")==0 || EC1Bt[9].BT4->getButtonText().compare("Dec/-1")==0))){
    ...
    else if (buttonThatWasClicked == ECO_BEH_EN3)
    {
		...
		if (!(EC1Bt[10].BT2->getButtonText().compare("MMC") == 0) && !(EC1Bt[10].BT2->getButtonText().compare("Program") == 0) 
			&& !(EC1Bt[10].BT2->getButtonText().compare("CC")==0 && (EC1Bt[10].BT4->getButtonText().compare("Inc/+1")==0 || EC1Bt[10].BT4->getButtonText().compare("Dec/-1")==0))){
    ...
    else if (buttonThatWasClicked == ECO_BEH_EN4)
    {
		...
		if (!(EC1Bt[11].BT2->getButtonText().compare("MMC") == 0) && !(EC1Bt[11].BT2->getButtonText().compare("Program") == 0) 
			&& !(EC1Bt[11].BT2->getButtonText().compare("CC")==0 && (EC1Bt[11].BT4->getButtonText().compare("Inc/+1")==0 || EC1Bt[11].BT4->getButtonText().compare("Dec/-1")==0))){
    ...
    else if (buttonThatWasClicked == ECO_BEH_EN5)
    {
		...
		if (!(EC1Bt[12].BT2->getButtonText().compare("MMC") == 0) && !(EC1Bt[12].BT2->getButtonText().compare("Program") == 0) 
			&& !(EC1Bt[12].BT2->getButtonText().compare("CC")==0 && (EC1Bt[12].BT4->getButtonText().compare("Inc/+1")==0 || EC1Bt[12].BT4->getButtonText().compare("Dec/-1")==0))){
    ...
    else if (buttonThatWasClicked == ECO_BEH_EN6)
    {
		...
		if (!(EC1Bt[13].BT2->getButtonText().compare("MMC") == 0) && !(EC1Bt[13].BT2->getButtonText().compare("Program") == 0) 
			&& !(EC1Bt[13].BT2->getButtonText().compare("CC")==0 && (EC1Bt[13].BT4->getButtonText().compare("Inc/+1")==0 || EC1Bt[13].BT4->getButtonText().compare("Dec/-1")==0))){
    ...
    else if (buttonThatWasClicked == ECO_BEH_EN7)
    {
		...
		if (!(EC1Bt[14].BT2->getButtonText().compare("MMC") == 0) && !(EC1Bt[14].BT2->getButtonText().compare("Program") == 0) 
			&& !(EC1Bt[14].BT2->getButtonText().compare("CC")==0 && (EC1Bt[14].BT4->getButtonText().compare("Inc/+1")==0 || EC1Bt[14].BT4->getButtonText().compare("Dec/-1")==0))){
    ...
    else if (buttonThatWasClicked == ECO_BEH_EN8)
    {
		...
		if (!(EC1Bt[15].BT2->getButtonText().compare("MMC") == 0) && !(EC1Bt[15].BT2->getButtonText().compare("Program") == 0) 
			&& !(EC1Bt[15].BT2->getButtonText().compare("CC")==0 && (EC1Bt[15].BT4->getButtonText().compare("Inc/+1")==0 || EC1Bt[15].BT4->getButtonText().compare("Dec/-1")==0))){
    ...
    else if (buttonThatWasClicked == ECO_LR_EN10)
    {
		...
		if (!(EC1Bt[0].BT2->getButtonText().compare("MMC") == 0)){
    ...
    else if (buttonThatWasClicked == ECO_LR_EN11)
    {
		...
		if (!(EC1Bt[1].BT2->getButtonText().compare("MMC") == 0)){
    ...
    else if (buttonThatWasClicked == ECO_LR_EN12)
    {
		...
		if (!(EC1Bt[2].BT2->getButtonText().compare("MMC") == 0)){
    ...
    else if (buttonThatWasClicked == ECO_LR_EN13)
    {
		...
		if (!(EC1Bt[3].BT2->getButtonText().compare("MMC") == 0)){
    ...
    else if (buttonThatWasClicked == ECO_LR_EN14)
    {
		...
		if (!(EC1Bt[4].BT2->getButtonText().compare("MMC") == 0)){
    ...
    else if (buttonThatWasClicked == ECO_LR_EN15)
    {
		...
		if (!(EC1Bt[5].BT2->getButtonText().compare("MMC") == 0)){
    ...
    else if (buttonThatWasClicked == ECO_LR_EN16)
    {
		...
		if (!(EC1Bt[6].BT2->getButtonText().compare("MMC") == 0)){
    ...
    else if (buttonThatWasClicked == ECO_LR_EN17)
    {
		...
		if (!(EC1Bt[7].BT2->getButtonText().compare("MMC") == 0)){
    ...
    else if (buttonThatWasClicked == ECOP_NO_EN1)
    {
        ...
        if (ECO_TY_EN1->getButtonText().compare("CC") == 0 /*|| ECO_TY_EN1->getButtonText().compare("Pitch") == 0*/)
        {
    ...
    else if (buttonThatWasClicked == ECOP_NO_EN2)
    {
        ...
        if (ECO_TY_EN2->getButtonText().compare("CC") == 0 /*|| ECO_TY_EN2->getButtonText().compare("Pitch") == 0*/)
        {
    ...
    else if (buttonThatWasClicked == ECOP_NO_EN3)
    {
        ...
        if (ECO_TY_EN3->getButtonText().compare("CC") == 0 /*|| ECO_TY_EN3->getButtonText().compare("Pitch") == 0*/)
        {
    ...
    else if (buttonThatWasClicked == ECOP_NO_EN4)
    {
        ...
        if (ECO_TY_EN4->getButtonText().compare("CC") == 0 /*|| ECO_TY_EN4->getButtonText().compare("Pitch") == 0*/)
        {
    ...
    else if (buttonThatWasClicked == ECOP_NO_EN5)
    {
        ...
        if (ECO_TY_EN5->getButtonText().compare("CC") == 0 /*|| ECO_TY_EN5->getButtonText().compare("Pitch") == 0*/)
        {
    ...
    else if (buttonThatWasClicked == ECOP_NO_EN6)
    {
        ...
        if (ECO_TY_EN6->getButtonText().compare("CC") == 0 /*|| ECO_TY_EN6->getButtonText().compare("Pitch") == 0*/)
        {
    ...
    else if (buttonThatWasClicked == ECOP_NO_EN7)
    {
        ...
        if (ECO_TY_EN7->getButtonText().compare("CC") == 0 /*|| ECO_TY_EN7->getButtonText().compare("Pitch") == 0*/)
        {
    ...
    else if (buttonThatWasClicked == ECOP_NO_EN8)
    {
        ...
        if (ECO_TY_EN8->getButtonText().compare("CC") == 0 /*|| ECO_TY_EN8->getButtonText().compare("Pitch") == 0*/)
        {
    ...
    else if (buttonThatWasClicked == ECOT_NO_EN3)
    {
        ...
        if (ECOT_TY_EN11->getButtonText().compare("CC") == 0 /*|| ECOT_TY_EN11->getButtonText().compare("Pitch") == 0*/)
        {
...
void EncodersCompact1To8Component::CustomTextButtonTextChanged (CustomTextButton* CustomTextButtonThatHasChanged)
{
    Load_or_SaveFlag =1;
	...
	for(int i =0;i<16;i++)
	{
		if(CustomTextButtonThatHasChanged == EC1Bt[i].BT1)
		{
			if(!(EC1Bt[i].BT1->GetValue().toString().compare("Off")==0) && !(EC1Bt[i].BT1->GetValue().toString().compare("Global")==0))
			{
				if(EC1Bt[i].BT1->GetValue().toString().getLastCharacters(1).compare("*")==0)
				{
					if(pGlobalCompactComponent->GetBT_CH2Num() != EC1Bt[i].BT1->GetValue().toString().dropLastCharacters(1).getIntValue())					
						EC1Bt[i].BT1->setButtonText(EC1Bt[i].BT1->GetValue().toString().dropLastCharacters(1));
					
				}
				else
				{
					if(pGlobalCompactComponent->GetBT_CH2Num() == EC1Bt[i].BT1->GetValue().toString().getIntValue())		
						EC1Bt[i].BT1->setButtonText(EC1Bt[i].BT1->GetValue().toString()+"*");
				}
			}
		}
	}
...
void EncodersCompact1To8Component::CustomTextbuttonClicked (CustomTextButton* buttonThatWasClicked)
{
    pMainComponent->setMyComponent(1);
...
void EncodersCompact1To8Component:: SetCurrentCustomBT2(CustomTextButton *currentbuttonThatWasClicked)
 {
     CurrentCustomBT2 = currentbuttonThatWasClicked;
 }

 CustomTextButton* EncodersCompact1To8Component:: GetCurrentCustomBT2()
 {
     return CurrentCustomBT2;
 }

void EncodersCompact1To8Component::CustomImagebuttonClicked (CustomImageButton* buttonThatWasClicked)
{
	...
	for (int i = 0; i < 16; i++)
    {
        if (EC1Bt[i].BT4 == buttonThatWasClicked || EC1Bt[i].BT5 == buttonThatWasClicked)
        {
            if (!(EC1Bt[i].BT2->getButtonText().compare("MMC") == 0) /*&& !(EMBt[i].BT2->getButtonText().compare("Program") == 0)*/)
            {
				if(!((EC1Bt[i].BT2->getButtonText().compare("Program") == 0) && EC1Bt[i].BT5 == buttonThatWasClicked && i>7) )
				{
					if(!(EC1Bt[i].BT5 == buttonThatWasClicked && (EC1Bt[i].BT4->getButtonText().compare("Inc/+1")==0 || EC1Bt[i].BT4->getButtonText().compare("Dec/-1")==0 
						|| EC1Bt[i].BT4->getButtonText().compare("Relative1")==0 || EC1Bt[i].BT4->getButtonText().compare("Relative2")==0|| EC1Bt[i].BT4->getButtonText().compare("Relative3")==0))){
						
						if (buttonThatWasClicked == pCustomImageButton1)
						{
							if(EC1Bt[i].BT2->getButtonText().compare("Note") == 0 || EC1Bt[i].BT2->getButtonText().compare("Pitch") == 0)
						...
						{
							if(EC1Bt[i].BT2->getButtonText().compare("CC")==0)
    ...
    for (int i = 0; i < 16; i++)
    {
        ...
        {
            if (EC1Bt[i].BT7 == MSB[i])
            {
                if (EC1Bt[i].BT2->getButtonText().compare("Program") == 0 /*|| EMBt[i].BT2->getButtonText().compare("Pitch") == 0*/)
                {
                    pMainComponent->FaderorOtherFlag = 0;
                    this->MidiLayerNum = 69 + 8 * i;
        ...
        {
            if (EC1Bt[i].BT8 == LSB[i])
            {
                if (EC1Bt[i].BT2->getButtonText().compare("Program") == 0)
                {
                    pMainComponent->FaderorOtherFlag = 0;
                    this->MidiLayerNum = 70 + 8 * i;
...
void EncodersCompact1To8Component::CustomImageButtonTextChanged (CustomImageButton* CustomImageButtonThatHasChanged)
{
    Load_or_SaveFlag =1;
}

void EncodersCompact1To8Component::MyCallOutBox(Component *p,Button* buttonThatWasClicked)
{
    CallOutBox::launchAsynchronously(p, buttonThatWasClicked->getScreenBounds(), nullptr);
}

 void EncodersCompact1To8Component:: SetCurrentCustomBT(CustomImageButton *currentbuttonThatWasClicked)
 {
     CurrentCustomBT = currentbuttonThatWasClicked;
 }


 CustomImageButton* EncodersCompact1To8Component:: GetCurrentCustomBT()
 {
     return CurrentCustomBT;
 }

 void EncodersCompact1To8Component::setCustomBTtoggle(bool s)
 {
     CurrentCustomBT->setState(Button::buttonOver);
     //CurrentCustomBT->setToggleState(s,dontSendNotification);
 }

 void EncodersCompact1To8Component::SetNO_BT(Button* buttonThatWasClicked)
 {
     NO_BT = buttonThatWasClicked;
 }
 Button* EncodersCompact1To8Component::GetNO_BT()
 {
    return NO_BT;
 }

 int EncodersCompact1To8Component::ConventNO_BTtoInt(String JK)
 {
	 int r;
	 //String ss
 ...
 int EncodersCompact1To8Component::GetNum()
 {
    return num;
 }

 void EncodersCompact1To8Component::GetCustomBtID()
 {
	for(int i=0;i<16;i++)
	 {
		 if (!(EC1Bt[i].BT1->getButtonText().compare("Global") == 0) && !(EC1Bt[i].BT1->getButtonText().compare("Off") == 0))
            ConstMidiLayerMessage[63 + 0 + i * 8] = (unsigned char)(EC1Bt[i].BT1->getButtonText().getIntValue() - 1) * 0x01;

        if (EC1Bt[i].BT4->getButtonText().compare("Dec/-1") == 0)
            ConstMidiLayerMessage[63 + 3 + i * 8] = 0x80;
        else if (EC1Bt[i].BT4->getButtonText().compare("Inc/+1") == 0)
            ConstMidiLayerMessage[63 + 3 + i * 8] = 0x81;
		else if (EC1Bt[i].BT4->getButtonText().compare("Relative1") == 0)
            ConstMidiLayerMessage[63 + 3 + i * 8] = 0x82;
		else if (EC1Bt[i].BT4->getButtonText().compare("Relative2") == 0)
            ConstMidiLayerMessage[63 + 3 + i * 8] = 0x83;
		else if (EC1Bt[i].BT4->getButtonText().compare("Relative3") == 0)
            ConstMidiLayerMessage[63 + 3 + i * 8] = 0x84;
        else if (!(EC1Bt[i].BT4->getButtonText().compare("-") == 0))
            ConstMidiLayerMessage[63 + 3 + i * 8] = (unsigned char)(EC1Bt[i].BT4->getButtonText().getIntValue()) * 0x01;

        if (!(EC1Bt[i].BT5->getButtonText().compare("-") == 0))
            ConstMidiLayerMessage[63 + 4 + i * 8] = (unsigned char)(EC1Bt[i].BT5->getButtonText().getIntValue()) * 0x01;

        if (ConstMidiLayerMessage[63 + 1 + i * 8] == 0x03){
            ConstMidiLayerMessage[63 + 6 + i * 8] = (unsigned char)(EC1Bt[i].BT7->getButtonText().getIntValue()) * 0x01;
            ConstMidiLayerMessage[63 + 7 + i * 8] = (unsigned char)(EC1Bt[i].BT8->getButtonText().getIntValue()) * 0x01;
        }
	}
 }

 void EncodersCompact1To8Component::SetAllButtonState(bool s)
 {
	for(int i = 0;i<16;i++)
	{
		EC1Bt[i].BT1 ->setEnabled(s);
		EC1Bt[i].BT2 ->setEnabled(s);
		EC1Bt[i].BT3 ->setEnabled(s);
		EC1Bt[i].BT4 ->setEnabled(s);
		EC1Bt[i].BT5 ->setEnabled(s);
		EC1Bt[i].BT6 ->setEnabled(s);
		EC1Bt[i].BT7 ->setEnabled(s);
		EC1Bt[i].BT8 ->setEnabled(s);
	}
 }

void EncodersCompact1To8Component::MakeButtonPointToBtGroup()
{
    EC1Bt[0].BT1 = pfader9;
    EC1Bt[0].BT2 = ECOT_TY_EN9;
    EC1Bt[0].BT3 = ECOT_NO_EN1;
    EC1Bt[0].BT4 = pCustomImageButton17;
    EC1Bt[0].BT5 = pCustomImageButton25;
    EC1Bt[0].BT6 = ECO_LR_EN10;
	EC1Bt[0].BT7 = MSB[0];
    EC1Bt[0].BT8 = LSB[0];

    EC1Bt[1].BT1 = pfader10;
    EC1Bt[1].BT2 = ECOT_TY_EN10;
    EC1Bt[1].BT3 = ECOT_NO_EN2;
    EC1Bt[1].BT4 = pCustomImageButton18;
    EC1Bt[1].BT5 = pCustomImageButton26;
    EC1Bt[1].BT6 = ECO_LR_EN11;
	EC1Bt[1].BT7 = MSB[1];
    EC1Bt[1].BT8 = LSB[1];

    EC1Bt[2].BT1 = pfader11;
    EC1Bt[2].BT2 = ECOT_TY_EN11;
    EC1Bt[2].BT3 = ECOT_NO_EN3;
    EC1Bt[2].BT4 = pCustomImageButton19;
    EC1Bt[2].BT5 = pCustomImageButton27;
    EC1Bt[2].BT6 = ECO_LR_EN12;
	EC1Bt[2].BT7 = MSB[2];
    EC1Bt[2].BT8 = LSB[2];

    EC1Bt[3].BT1 = pfader12;
    EC1Bt[3].BT2 = ECOT_TY_EN12;
    EC1Bt[3].BT3 = ECOT_NO_EN4;
    EC1Bt[3].BT4 = pCustomImageButton20;
    EC1Bt[3].BT5 = pCustomImageButton28;
    EC1Bt[3].BT6 = ECO_LR_EN13;
	EC1Bt[3].BT7 = MSB[3];
    EC1Bt[3].BT8 = LSB[3];

    EC1Bt[4].BT1 = pfader13;
    EC1Bt[4].BT2 = ECOT_TY_EN13;
    EC1Bt[4].BT3 = ECOT_NO_EN5;
    EC1Bt[4].BT4 = pCustomImageButton21;
    EC1Bt[4].BT5 = pCustomImageButton29;
    EC1Bt[4].BT6 = ECO_LR_EN14;
	EC1Bt[4].BT7 = MSB[4];
    EC1Bt[4].BT8 = LSB[4];

    EC1Bt[5].BT1 = pfader14;
    EC1Bt[5].BT2 = ECOT_TY_EN14;
    EC1Bt[5].BT3 = ECOT_NO_EN6;
    EC1Bt[5].BT4 = pCustomImageButton22;
    EC1Bt[5].BT5 = pCustomImageButton30;
    EC1Bt[5].BT6 = ECO_LR_EN15;
	EC1Bt[5].BT7 = MSB[5];
    EC1Bt[5].BT8 = LSB[5];

    EC1Bt[6].BT1 = pfader15;
    EC1Bt[6].BT2 = ECOT_TY_EN15;
    EC1Bt[6].BT3 = ECOT_NO_EN7;
    EC1Bt[6].BT4 = pCustomImageButton23;
    EC1Bt[6].BT5 = pCustomImageButton31;
    EC1Bt[6].BT6 = ECO_LR_EN16;
	EC1Bt[6].BT7 = MSB[6];
    EC1Bt[6].BT8 = LSB[6];

    EC1Bt[7].BT1 = pfader16;
    EC1Bt[7].BT2 = ECOT_TY_EN16;
    EC1Bt[7].BT3 = ECOT_NO_EN8;
    EC1Bt[7].BT4 = pCustomImageButton24;
    EC1Bt[7].BT5 = pCustomImageButton32;
    EC1Bt[7].BT6 = ECO_LR_EN17;
	EC1Bt[7].BT7 = MSB[7];
    EC1Bt[7].BT8 = LSB[7];

    EC1Bt[8].BT1 = pfader1;
    EC1Bt[8].BT2 = ECO_TY_EN1;
    EC1Bt[8].BT3 = ECOP_NO_EN1;
    EC1Bt[8].BT4 = pCustomImageButton1;
    EC1Bt[8].BT5 = pCustomImageButton9;
    EC1Bt[8].BT6 = ECO_BEH_EN1;
	EC1Bt[8].BT7 = MSB[8];
    EC1Bt[8].BT8 = LSB[8];

    EC1Bt[9].BT1 = pfader2;
    EC1Bt[9].BT2 = ECO_TY_EN2;
    EC1Bt[9].BT3 = ECOP_NO_EN2;
    EC1Bt[9].BT4 = pCustomImageButton2;
    EC1Bt[9].BT5 = pCustomImageButton10;
    EC1Bt[9].BT6 = ECO_BEH_EN2;
	EC1Bt[9].BT7 = MSB[9];
    EC1Bt[9].BT8 = LSB[9];

    EC1Bt[10].BT1 = pfader3;
    EC1Bt[10].BT2 = ECO_TY_EN3;
    EC1Bt[10].BT3 = ECOP_NO_EN3;
    EC1Bt[10].BT4 = pCustomImageButton3;
    EC1Bt[10].BT5 = pCustomImageButton11;
    EC1Bt[10].BT6 = ECO_BEH_EN3;
	EC1Bt[10].BT7 = MSB[10];
    EC1Bt[10].BT8 = LSB[10];

    EC1Bt[11].BT1 = pfader4;
    EC1Bt[11].BT2 = ECO_TY_EN4;
    EC1Bt[11].BT3 = ECOP_NO_EN4;
    EC1Bt[11].BT4 = pCustomImageButton4;
    EC1Bt[11].BT5 = pCustomImageButton12;
    EC1Bt[11].BT6 = ECO_BEH_EN4;
	EC1Bt[11].BT7 = MSB[11];
    EC1Bt[11].BT8 = LSB[11];

    EC1Bt[12].BT1 = pfader5;
    EC1Bt[12].BT2 = ECO_TY_EN5;
    EC1Bt[12].BT3 = ECOP_NO_EN5;
    EC1Bt[12].BT4 = pCustomImageButton5;
    EC1Bt[12].BT5 = pCustomImageButton13;
    EC1Bt[12].BT6 = ECO_BEH_EN5;
	EC1Bt[12].BT7 = MSB[12];
    EC1Bt[12].BT8 = LSB[12];

    EC1Bt[13].BT1 = pfader6;
    EC1Bt[13].BT2 = ECO_TY_EN6;
    EC1Bt[13].BT3 = ECOP_NO_EN6;
    EC1Bt[13].BT4 = pCustomImageButton6;
    EC1Bt[13].BT5 = pCustomImageButton14;
    EC1Bt[13].BT6 = ECO_BEH_EN6;
	EC1Bt[13].BT7 = MSB[13];
    EC1Bt[13].BT8 = LSB[13];

    EC1Bt[14].BT1 = pfader7;
    EC1Bt[14].BT2 = ECO_TY_EN7;
    EC1Bt[14].BT3 = ECOP_NO_EN7;
    EC1Bt[14].BT4 = pCustomImageButton7;
    EC1Bt[14].BT5 = pCustomImageButton15;
    EC1Bt[14].BT6 = ECO_BEH_EN7;
	EC1Bt[14].BT7 = MSB[14];
    EC1Bt[14].BT8 = LSB[14];

    EC1Bt[15].BT1 = pfader8;
    EC1Bt[15].BT2 = ECO_TY_EN8;
    EC1Bt[15].BT3 = ECOP_NO_EN8;
    EC1Bt[15].BT4 = pCustomImageButton8;
    EC1Bt[15].BT5 = pCustomImageButton16;
    EC1Bt[15].BT6 = ECO_BEH_EN8;
	EC1Bt[15].BT7 = MSB[15];
    EC1Bt[15].BT8 = LSB[15];
}

void EncodersCompact1To8Component::UpdateEncode1TO8Bt(int s)
{
    for (int i = 0; i<8; i++)  //encoder turn 
     {
         //EMBt[i].BT1->setButtonText(String(MiniConstMidiLayerMessage[s + 6 * i] + 1));
         if (ConstMidiLayerMessage[s + 8 * i] == 17*0x01)       EC1Bt[i].BT1->setButtonText("Global");
         else if (ConstMidiLayerMessage[s + 8 * i] == 18 * 0x01){  
			if((pGlobalCompactComponent->GetBT_CH2Num())*0x01 == ConstMidiLayerMessage[s + 8 * i] )
				EC1Bt[i].BT1->setButtonText("Off*");
			else			
				EC1Bt[i].BT1->setButtonText("Off");
		 }
		 else{
			if((pGlobalCompactComponent->GetBT_CH2Num() - 1)*0x01 == ConstMidiLayerMessage[s + 8 * i] )
				EC1Bt[i].BT1->setButtonText(String(ConstMidiLayerMessage[s + 8 * i]+0x01)+"*");
			else
				EC1Bt[i].BT1->setButtonText(String(ConstMidiLayerMessage[s + 8 * i]+0x01));
		 }

         if (ConstMidiLayerMessage[s + 8 * i + 1] == 0) { EC1Bt[i].BT2->setButtonText("CC");           EC1Bt[i].BT3->setButtonText("CC" + String(ConstMidiLayerMessage[s + 8 * i + 2])); }
         else if (ConstMidiLayerMessage[s + 8 * i + 1] == 0x01) { EC1Bt[i].BT2->setButtonText("Note");        EC1Bt[i].BT3->setButtonText(Midimusic[ConstMidiLayerMessage[s + 8 * i + 2]]); }
         else if (ConstMidiLayerMessage[s + 8 * i + 1] == 0x02) { EC1Bt[i].BT2->setButtonText("Pitch");        EC1Bt[i].BT3->setButtonText(/*String(CCBT[MiniConstMidiLayerMessage[s + 8 * i + 2 ]])*/"-"); }
         else if (ConstMidiLayerMessage[s + 8 * i + 1] == 0x03) { EC1Bt[i].BT2->setButtonText("Program");   EC1Bt[i].BT3->setButtonText(/*String(CCBT[MiniConstMidiLayerMessage[s + 8 * i + 2]])*/"-"); }
         else if (ConstMidiLayerMessage[s + 8 * i + 1] == 0x04) { EC1Bt[i].BT2->setButtonText("MMC");       EC1Bt[i].BT3->setButtonText(String(MMC_Functions_e[ConstMidiLayerMessage[s + 8 * i + 2]])); }

         if (/*MiniConstMidiLayerMessage[s + 8 * i + 1] != 0x02 &&*/ ConstMidiLayerMessage[s + 8 * i + 1] != 0x04)
         {
             if (ConstMidiLayerMessage[s + 8 * i + 3] == 0x80)             EC1Bt[i].BT4->setButtonText("Dec/-1");
             else if (ConstMidiLayerMessage[s + 8 * i + 3] == 0x81)             EC1Bt[i].BT4->setButtonText("Inc/+1");
			 else if(ConstMidiLayerMessage[s + 8 * i + 3] == 0x82)
			 {
				 if (ConstMidiLayerMessage[s + 8 * i + 1] == 0)             
					EC1Bt[i].BT4->setButtonText("Relative1");
				 else{ 
					EC1Bt[i].BT4->setButtonText("0");
			 ...
			 {
				 if (ConstMidiLayerMessage[s + 8 * i + 1] == 0)             
					EC1Bt[i].BT4->setButtonText("Relative2");
				 else{ 
					EC1Bt[i].BT4->setButtonText("0");
					ConstMidiLayerMessage[s + 8 * i + 3] =0;
				}
			 ...
			 {
				 if (ConstMidiLayerMessage[s + 8 * i + 1] == 0)             
					EC1Bt[i].BT4->setButtonText("Relative3");
				 else{ 
					EC1Bt[i].BT4->setButtonText("0");
					ConstMidiLayerMessage[s + 8 * i + 3] =0;
				}
			 }
             else  EC1Bt[i].BT4->setButtonText(String(ConstMidiLayerMessage[s + 8 * i + 3]));
             ...
             {
                 if (ConstMidiLayerMessage[s + 8 * i + 4] == 0x80)             EC1Bt[i].BT5->setButtonText("Dec/-1");
                 else if (ConstMidiLayerMessage[s + 8 * i + 4] == 0x81)             EC1Bt[i].BT5->setButtonText("Inc/+1");
				 
                 else                                                       EC1Bt[i].BT5->setButtonText(String(ConstMidiLayerMessage[s + 8 * i + 4]));
             }

             if (ConstMidiLayerMessage[s + 8 * i + 5] == 0x00)            EC1Bt[i].BT6->setButtonText("Single");
             else if (ConstMidiLayerMessage[s + 8 * i + 5] == 0x01)      EC1Bt[i].BT6->setButtonText("Pan");
             else if (ConstMidiLayerMessage[s + 8 * i + 5] == 0x02)      EC1Bt[i].BT6->setButtonText("Fan");
             else if (ConstMidiLayerMessage[s + 8 * i + 5] == 0x03)      EC1Bt[i].BT6->setButtonText("Spread");
             else if (ConstMidiLayerMessage[s + 8 * i + 5] == 0x04)      EC1Bt[i].BT6->setButtonText("Trim");
         }
         else{
             EC1Bt[i].BT4->setButtonText("-");
             EC1Bt[i].BT5->setButtonText("-");
             EC1Bt[i].BT6->setButtonText("-");
         }

         if (ConstMidiLayerMessage[s + 8 * i + 1] == 0x03 /*|| MiniConstMidiLayerMessage[s + 8 * i + 1] == 0x02*/) {
             EC1Bt[i].BT7->setButtonText(String(ConstMidiLayerMessage[s + 8 * i + 6]));
             EC1Bt[i].BT8->setButtonText(String(ConstMidiLayerMessage[s + 8 * i + 7]));
         }
         else{
     ...
     for (int i = 0; i<8; i++)   //encoder push
     {
         ...
         if (ConstMidiLayerMessage[s + 8 * i + 64] == 17 * 0x01)       EC1Bt[8 + i].BT1->setButtonText("Global");
			...
			if((pGlobalCompactComponent->GetBT_CH2Num())*0x01 == ConstMidiLayerMessage[s + 8 * i + 64] )
				EC1Bt[8 + i].BT1->setButtonText("Off*");
			else			
				EC1Bt[8 + i].BT1->setButtonText("Off");
		 }
		 else{
			if((pGlobalCompactComponent->GetBT_CH2Num() - 1)*0x01 == ConstMidiLayerMessage[s + 8 * i + 64] )
				EC1Bt[8 + i].BT1->setButtonText(String(ConstMidiLayerMessage[s + 8 * i + 64]+0x01)+"*");
			else
				EC1Bt[8 + i].BT1->setButtonText(String(ConstMidiLayerMessage[s + 8 * i + 64]+0x01));
		 }

         if (ConstMidiLayerMessage[s + 8 * i + 1 + 64] == 0) { EC1Bt[8 + i].BT2->setButtonText("CC");           EC1Bt[8 + i].BT3->setButtonText("CC" + String(ConstMidiLayerMessage[s + 8 * i + 2 + 64])); }
         else if (ConstMidiLayerMessage[s + 8 * i + 1 + 64] == 0x01) { EC1Bt[8 + i].BT2->setButtonText("Note");        EC1Bt[8 + i].BT3->setButtonText(Midimusic[ConstMidiLayerMessage[s + 8 * i + 2 + 64]]);}
         else if (ConstMidiLayerMessage[s + 8 * i + 1 + 64] == 0x02) { EC1Bt[8 + i].BT2->setButtonText("Pitch");        EC1Bt[8 + i].BT3->setButtonText(/*String(CCBT[MiniConstMidiLayerMessage[s + 8 * i + 2 + 64]])*/"-"); }
         else if (ConstMidiLayerMessage[s + 8 * i + 1 + 64] == 0x03) { EC1Bt[8 + i].BT2->setButtonText("Program");   EC1Bt[8 + i].BT3->setButtonText(/*String(CCBT[MiniConstMidiLayerMessage[s + 8 * i + 2 + 64]])*/"-"); }
         else if (ConstMidiLayerMessage[s + 8 * i + 1 + 64] == 0x04) { EC1Bt[8 + i].BT2->setButtonText("MMC");       EC1Bt[8 + i].BT3->setButtonText(String(MMC_Functions_e[ConstMidiLayerMessage[s + 8 * i + 2 + 64]])); }
         ...
         { 
			 ...
			 {	 
				 if(ConstMidiLayerMessage[s + 8 * i + 1 + 64] != 0x01 && ConstMidiLayerMessage[s + 8 * i + 1 + 64] != 0x02)
					EC1Bt[8 + i].BT4->setButtonText("Dec/-1");  
				 else{
					 EC1Bt[8 + i].BT4->setButtonText("0");  ConstMidiLayerMessage[s + 8 * i + 3 + 64]= 0;}
			 }
             else if (ConstMidiLayerMessage[s + 8 * i + 3 + 64] == 0x81)  
			 {
				 if(ConstMidiLayerMessage[s + 8 * i + 1 + 64] != 0x01 && ConstMidiLayerMessage[s + 8 * i + 1 + 64] != 0x02)
					EC1Bt[8 + i].BT4->setButtonText("Inc/+1");
				 else{
					 EC1Bt[8 + i].BT4->setButtonText("0");  ConstMidiLayerMessage[s + 8 * i + 3 + 64]= 0;}
			 }
			 //else if (ConstMidiLayerMessage[s + 8 * i + 3 + 64] == 0x82)             EC1Bt[8 + i].BT4->setButtonText("Relative");
             else EC1Bt[8 + i].BT4->setButtonText(String(ConstMidiLayerMessage[s + 8 * i + 3 + 64]));
             
             if (ConstMidiLayerMessage[s + 8 * i + 3 + 64] == 0x80 || ConstMidiLayerMessage[s + 8 * i + 3 + 64] == 0x81 || ConstMidiLayerMessage[s + 8 * i + 1 + 64] == 0x03)
                 EC1Bt[8 + i].BT5->setButtonText("-");
             else
             {
                 if (ConstMidiLayerMessage[s + 8 * i + 4 + 64] == 0x80)             EC1Bt[8 + i].BT5->setButtonText("Dec/-1");
                 else if (ConstMidiLayerMessage[s + 8 * i + 4 + 48] == 0x81)             EC1Bt[8 + i].BT5->setButtonText("Inc/+1");
                 else                                                                                            EC1Bt[8 + i].BT5->setButtonText(String(ConstMidiLayerMessage[s + 8 * i + 4 + 64]));
             }

			 if(ConstMidiLayerMessage[s + 8 * i + 1 + 64] == 0x03){EC1Bt[8 + i].BT6->setButtonText("Momentary"); ConstMidiLayerMessage[s + 8 * i + 5 + 64] = 0;}
			 ...
			 {
				 EC1Bt[8 + i].BT6->setButtonText("Momentary");
				 ConstMidiLayerMessage[s + 8 * i + 5 + 64] = 0;
			 }
			 else 
			 {
				if (ConstMidiLayerMessage[s + 8 * i + 5 + 64] == 0x00) EC1Bt[8 + i].BT6->setButtonText("Momentary");
				else EC1Bt[8 + i].BT6->setButtonText("Toggle");
			 }
         }
         else{
             EC1Bt[8 + i].BT4->setButtonText("-");
             EC1Bt[8 + i].BT5->setButtonText("-");
             EC1Bt[8 + i].BT6->setButtonText("-");
         }

         if (ConstMidiLayerMessage[s + 8 * i + 64 + 1] == 0x03 /*|| MiniConstMidiLayerMessage[s + 8 * i + 64 + 1] == 0x02*/) {
             EC1Bt[8 + i].BT7->setButtonText(String(ConstMidiLayerMessage[s + 8 * i + 6 + 64]));
             EC1Bt[8 + i].BT8->setButtonText(String(ConstMidiLayerMessage[s + 8 * i + 7 + 64]));
         }
         else{
             EC1Bt[8 + i].BT7->setButtonText("-");
             EC1Bt[8 + i].BT8->setButtonText("-");
         }
     }
	repaint();
...
<JUCER_COMPONENT documentType="Component" className="EncodersCompact1To8Component"
  ...
  <TEXTBUTTON name="new button" id="fa29ee890cee7258" memberName="ECOP_NO_EN2"
              ...
              bgColOn="ffd2691e" textCol="ffffab00" textColOn="ffffab00" buttonText="CC8"
              connectedEdges="15" needsCallback="1" radioGroupId="0"/>
  ...
  <TEXTBUTTON name="new button" id="868db2010c173f73" memberName="ECOT_NO_EN5"
              ...
              bgColOn="ffd2691e" textCol="ffffab00" textColOn="ffffab00" buttonText="CC2"
              connectedEdges="15" needsCallback="1" radioGroupId="0"/>
  ...
  <TEXTBUTTON name="new button" id="4cff17be09bc933f" memberName="ECOT_NO_EN7"
              ...
              bgColOn="ffd2691e" textCol="ffffab00" textColOn="ffffab00" buttonText="CC11"
              connectedEdges="15" needsCallback="1" radioGroupId="0"/>
