...
#ifdef MMM
                const double proportionDelta = (wheel.deltaX != 0 ? -wheel.deltaX : wheel.deltaY) * 0.05f;
#else
...
#ifdef MMM
void Slider::setRotaryNull (const int position)
{
#if 0
    switch(position) {
    case 0: rotaryNull = rotaryStart;           break;
    case 1: rotaryNull = float_Pi * 2.0f;       break;
    case 2: rotaryNull = rotaryEnd;             break; 
    default: rotaryNull = rotaryStart;          break;    
    }
#endif  //waittosee

    /*
            and in slider constructor function there to be add:     rotaryNull = rotaryStart;
            ??? waittosee
